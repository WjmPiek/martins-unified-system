"""Auto gross method by agreement start date

Revision ID: v34_auto_gross_method
Revises: v33_cash_calc
Create Date: 2026-06-13
"""
from alembic import op

revision = "v34_auto_gross_method"
down_revision = "v33_cash_calc"
branch_labels = None
depends_on = None
    ...
    if dialect == "postgresql":
        ...
        WITH bases AS (
            ...
            SELECT
                ...
                admin_fee_calc,
                CASE
                    WHEN royalty_gross_method = 'new' THEN sales_calc + admin_fee_calc
        ...
        # SQLite/dev fallback: new Python logic applies on import/save.
        pass
