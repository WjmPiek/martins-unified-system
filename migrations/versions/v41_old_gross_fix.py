"""Ensure Old Gross uses Sales plus Insurance Receipts

Revision ID: v41_old_gross_fix
Revises: v40_royalty_recalc
Create Date: 2026-06-13
"""
from alembic import op

revision = "v41_old_gross_fix"
down_revision = "v40_royalty_recalc"
branch_labels = None
depends_on = None
        ...
        SELECT
            ...
            COALESCE((
                ...
                WHERE rs.franchise_id = c.franchise_id
                  ...
                  AND (c.royalty_base <= COALESCE(rs.amount_to,0) OR COALESCE(rs.amount_to,0) <= 0)
