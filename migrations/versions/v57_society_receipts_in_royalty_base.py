"""Include society receipts in royalty gross methods

Revision ID: v57_society_royalty
Revises: v42_old_no_ins
Create Date: 2026-06-13
"""
from alembic import op

revision = "v57_society_royalty"
down_revision = "v42_old_no_ins"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    WITH bases AS (
        SELECT
            mf.id,
            COALESCE(f.royalty_gross_method, 'old') AS method,
